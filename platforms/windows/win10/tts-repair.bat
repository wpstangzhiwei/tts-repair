...
echo ============================================================
echo Win10 TTS Repair - Check ^> Repair ^> Verify
echo ============================================================
...
if "!RC!"=="0" (
  echo.
  echo [SUCCESS] Win10 TTS repair completed.
) else (
  echo.
  echo [FAILED] Win10 TTS repair did not complete. See messages above.
)
exit /b !RC!
